...
var CustomImportScript = (() => {
  ...
  var PAGE_TEMPLATE = {
    ...
    description: "Editorial article with hero header, breadcrumbs, pull quote, and stacked rich-text body sections",
    urls: [
    ...
    blocks: [
      {
        name: "breadcrumbs",
        instances: [".breadcrumb", ".cmp-breadcrumb"]
      }
    ],
    sections: [
      { id: "logical-1", name: "hero-header", selector: [".cmp-layout-container--fixed .image:not(.cmp-image--logo)", ".cmp-layout-container--fixed"], style: null, blocks: [], defaultContent: [".image"] },
      { id: "logical-2", name: "breadcrumbs", selector: [".breadcrumb", ".cmp-breadcrumb"], style: null, blocks: ["breadcrumbs"], defaultContent: [] },
      { id: "logical-3", name: "article-body", selector: ["main.container.responsivegrid.cmp-layout-container--fixed", ".cmp-layout-container--fixed"], style: null, blocks: [], defaultContent: [".title", ".text", ".image"] }
    ]
  };
  var transformers = [
    transform,
