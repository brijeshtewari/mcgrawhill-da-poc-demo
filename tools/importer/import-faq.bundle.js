...
var CustomImportScript = (() => {
  ...
  var PAGE_TEMPLATE = {
    name: "faq",
    description: "Support page with a hero header and an accordion of expandable question and answer items",
    urls: [
    ...
    blocks: [
      {
        name: "hero",
        instances: [".title.cmp-title--underline", ".cmp-title--underline"]
      },
      {
        name: "accordion",
    ...
    sections: [
      {
        id: "logical-1",
        name: "FAQ Content",
        selector: [".cmp-layout-container--fixed", "main.container.responsivegrid"],
        style: null,
